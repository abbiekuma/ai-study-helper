...
export function QuizPanel({
  ...
  return (
    <aside className="flex min-w-0 flex-1 flex-col border-l border-border bg-quiz overflow-hidden">
      <div className="border-b border-[#f0dbc0] px-3 py-2 text-sm font-medium text-stone-700 flex items-center justify-between gap-2">
        <span>Quiz</span>
        {quizzes.length > 1 && (
          <select
            value={quizId ?? ''}
        ...
        {onToggleSaved != null && (
            <button
              ...
              className="rounded px-2 py-1 text-xs font-medium text-primary-muted-foreground hover:bg-primary-muted/50"
